...
pub(super) fn encode_params(params: &TransportParameters) -> Bytes {
...
pub(super) fn encode_early_data_context(
    ...
    hasher
        .update(&params.initial_max_data.0.to_ne_bytes())
        .unwrap();
    hasher
        .update(&params.initial_max_stream_data_bidi_local.0.to_ne_bytes())
        .unwrap();
    hasher
        .update(&params.initial_max_stream_data_bidi_remote.0.to_ne_bytes())
        .unwrap();
    hasher
        .update(&params.initial_max_stream_data_uni.0.to_ne_bytes())
        .unwrap();
    hasher
        .update(&params.initial_max_streams_bidi.0.to_ne_bytes())
        .unwrap();
    hasher
        .update(&params.initial_max_streams_uni.0.to_ne_bytes())
        .unwrap();
    hasher
        .update(&params.active_connection_id_limit.0.to_ne_bytes())
        .unwrap();
